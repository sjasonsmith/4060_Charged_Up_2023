...
public class RotateToHeadingCommand extends CommandBase {
  ...
  private final double goalHeadingRadians;
  ...
  public RotateToHeadingCommand(
        ...
        double goalHeadingDegrees,
        Boolean exitIfRollEncountered) {
    this.drivetrainSubsystem = drivetrainSubsystem;
    this.poseProvider = poseProvider;
    goalHeadingRadians = Units.degreesToRadians(goalHeadingDegrees);
  ...
  public void initialize() {
    ...
    thetaController.setGoal(goalHeadingRadians);
  ...
  public boolean isFinished() {
    ...
    Boolean atGoal = thetaController.atGoal();
