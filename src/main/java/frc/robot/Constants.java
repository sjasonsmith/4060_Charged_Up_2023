...
public final class Constants {
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(188.);
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(258.2);
